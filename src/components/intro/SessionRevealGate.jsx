        ...
        {!isDone && (
          ...
          >
            <motion.div
              ...
              animate={
                isOpening ? { y: "-104%", opacity: 1 } : { y: "0%", opacity: 1 }
              }
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-cyan-100/12 bg-[#06101f]/50 px-8 py-7 text-center shadow-[0_26px_90px_rgba(0,0,0,0.42),0_0_42px_rgba(34,211,238,0.1),inset_0_1px_0_rgba(255,255,255,0.07)] backdrop-blur-xl sm:px-12 sm:py-8">
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <span className="pointer-events-none absolute inset-y-0 -left-14 w-12 -skew-x-12 bg-linear-to-r from-transparent via-cyan-100/18 to-transparent opacity-0 blur-[1px] transition-all duration-700 ease-out group-hover:left-[115%] group-hover:opacity-100" />
